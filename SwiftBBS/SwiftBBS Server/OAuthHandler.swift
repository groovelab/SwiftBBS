...
class OAuthHandler : BaseRequestHandler {
    ...
    func facebookAction() throws -> ActionResponse {
        //  TODO: add state
        let authUrl = "https://www.facebook.com/dialog/oauth?client_id=\(Config.facebookClientId)&redirect_uri=\(facebookRedirectUri)"
    ...
    private func getFacebookAccessToken(code code: String) throws -> String? {
        let url = "https://graph.facebook.com/v2.3/oauth/access_token?client_id=\(Config.facebookClientId)&redirect_uri=\(facebookRedirectUri)&client_secret=\(Config.facebookClientSecret)&code=\(code)"
        /*
        response example
